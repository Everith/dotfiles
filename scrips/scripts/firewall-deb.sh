...
iptables -A PREROUTING -t nat -i enp4s0 -p tcp --dport 9117 -j DNAT --to-destination 192.168.33.2:9117
iptables -A FORWARD -p tcp -d 192.168.33.2 --dport 9117 -j ACCEPT
# radarr Fonyod
echo "Redirecting Radarr"
iptables -A PREROUTING -t nat -i enp4s0 -p tcp --dport 7878 -j DNAT --to-destination 192.168.33.2:7878
iptables -A FORWARD -p tcp -d 192.168.33.2 --dport 7878 -j ACCEPT
# sonarr Fonyod
echo "Redirecting Sonarr"
iptables -A PREROUTING -t nat -i enp4s0 -p tcp --dport 8989 -j DNAT --to-destination 192.168.33.2:8989
...
iptables -A PREROUTING -t nat -i enp4s0 -p tcp --dport 139 -j DNAT --to-destination 192.168.33.2:139
iptables -A FORWARD -p tcp -d 192.168.33.2 --dport 139 -j ACCEPT
iptables -A PREROUTING -t nat -i enp4s0 -p udp --dport 138 -j DNAT --to-destination 192.168.33.2:138
iptables -A FORWARD -p udp -d 192.168.33.2 --dport 138 -j ACCEPT
iptables -A PREROUTING -t nat -i enp4s0 -p udp --dport 137 -j DNAT --to-destination 192.168.33.2:137
